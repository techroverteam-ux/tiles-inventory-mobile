...
export const ScreenActionBar: React.FC<ScreenActionBarProps> = ({
  ...
  const styles = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: 'bold', color: theme.text, marginBottom: 16, letterSpacing: -0.5 },
    actionsRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 20 },
    outlineBtn: {
    ...
    primaryBtn: {
      ...
      backgroundColor: theme.primary, paddingHorizontal: 12, paddingVertical: 10,
      borderRadius: 12, gap: 6,
    },
    primaryBtnText: { color: theme.primaryForeground, fontWeight: '700', fontSize: 14 },
    metaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    itemCount: { color: theme.mutedForeground, fontSize: 14 },
    toggleGroup: {
      flexDirection: 'row', backgroundColor: theme.surface,
      borderWidth: 1, borderColor: theme.border, borderRadius: 8, overflow: 'hidden',
    },
    toggleBtn: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, gap: 6 },
    toggleBtnActive: { backgroundColor: theme.muted },
    toggleText: { fontSize: 12, fontWeight: '700', color: theme.mutedForeground, letterSpacing: 0.5 },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.actionsRow}>
        ...
        >
          ...
          <Text style={styles.outlineBtnText}>{exporting ? 'Exporting...' : 'Export'}</Text>
        </TouchableOpacity>
